...
public class checkoutView extends javax.swing.JFrame {
    ...
    // <editor-fold defaultstate="collapsed" desc="Generated Code">//GEN-BEGIN:initComponentss
    private void initComponents() {
        ...
        if(userModel.getUserType() == Enums.UserType.REGISTERED || userModel.getUserType() == Enums.UserType.SUBSCRIPTION) {
            ...
            jTextField1.setText(registeredUserModel.getFirstName());
            jTextField2.setText(registeredUserModel.getLastName());
            jTextField8.setText(registeredUserModel.getPhoneNumber());
            jTextField9.setText(registeredUserModel.getEmail());
        }
