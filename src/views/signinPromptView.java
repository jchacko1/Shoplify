 ...
 * @author ART
 */
public class signinPromptView extends javax.swing.JFrame {

    /**
     * Creates new form signinPrompt
     */
    public signinPromptView() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(signinPromptView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new signinPromptView().setVisible(true);
            }
        });
    }
